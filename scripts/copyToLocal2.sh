...
mongoimport --drop --db medpharma --collection purchases --file temp/purchases.json
mongoimport --drop --db medpharma --collection productsV2 --file temp/productsV2.json
